...
InputDict=OrderedDict(
        ...
        "mwcs_smoothing_half_win" => ("5", Int, "[Points] MWCS smoothing half windown length."),
        ...
        "computedqq_smoothing_windowlength"  => ("5", Float64, "[s] smoothing windown length to compute envelope for compute_dvvdqq."),
