...
InputDict=OrderedDict(
        ...
        #===SeisDownload===#
        "donwload_time_unit"    => ("600", Int, "[s] Unit time of data request. (e.g. request data for each 10minutes."),
        "donwload_margin"       => ("300", Int, "[s] Download margin to be clipped to avoid edge effect."),
        ...
        "outputformat"          => ("JLD2", Bool, "JLD2 or ASDF: use JLD2 if you perform the following processes with SeisMonitoring.jl"),
)
